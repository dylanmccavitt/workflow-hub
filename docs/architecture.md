...
5. The local API resolves linked GitHub PRs from Linear and git metadata, then reads status, review decision, checks, failing annotations, comments, changed files, unified diff hunks, and links without mutating GitHub.
